/*
 *  vbHmmTsFret_Main.c
 *  Model-specific main function for VB-HMM-TS-FRET.
 *
...
int main( int argc, char *argv[] ){
    ...
    if( argc != 8 ){
        ...
        fprintf( stderr, "\nVariational-Bayesian Hidden-Markov-Model Time-Stamp FRET Analysis\n" );
        fprintf( stderr, "    built on 2010.09.24\n" );
        fprintf( stderr, "Syntax : vbHmmTsFret sFrom sMax trials maxIteration threshold d_filename a_filename\n" );
        ...
        fprintf( stderr, "Example: vbHmmTsFret 2 20 5 1000 1e-10 D-data A-data\n\n" );
        freeRan();
        exit(1);
